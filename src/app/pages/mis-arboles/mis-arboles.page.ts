...
@Component({
  selector: 'app-mis-arboles',
  templateUrl: './mis-arboles.page.html',
  styleUrls: ['./mis-arboles.page.scss'],
})
export class MisArbolesPage implements OnInit {
  ...
  async ngOnInit() {
    const alert = await this.alertController.create({
      header: 'Tus Arboles',
      message: '¡Aquí esta tu listado de árboles favoritos! Recuerda que los usuarios comparten los arboles ingresados en este móvil',
      buttons: ["¡Vamos!"],
    });
    await alert.present()
  }
